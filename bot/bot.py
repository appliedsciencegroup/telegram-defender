...
# Imports the timer function from threading
...
# Imports the Avira Antivirus method
...
# This function checks to see if the URL is in the Allsides JSON
...
def send_welcome(message):
    ...
    if groups.get_chat_by_id(message.chat.id) is not None:
        ...
        # groups_dict = save_chat_to_json(str(message.chat.id), groups_dict, mode=1, mute=0, bias=1)
